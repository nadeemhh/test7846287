...
<h3 class="child marginb" style="color: white">${Number(summaryData.EarningsPerShare.value.replace('$',''))>=0?summaryData.EarningsPerShare.value:removehypen(summaryData.EarningsPerShare.value.replace('$',''))}</h3>
</div>
...
<h3 class="child marginb" style="color: white">${Number(data.otherdata[5].replace('B','').replace('M',''))>=0?`$${data.otherdata[5]}`:removehypen(data.otherdata[5])}</h3>
</div>
